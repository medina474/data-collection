\COPY adherents(adherent_id,jardin_id,adherent,profil_id,depot_id,email,date_sortie) TO 'data/adherents.csv' (FORMAT CSV, header, ENCODING 'UTF8');
...
\COPY abonnements TO 'data/abonnements-2025.csv' (FORMAT CSV, header, ENCODING 'UTF8');
