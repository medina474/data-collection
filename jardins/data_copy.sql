...
update livraisons_import set depot = 41 where depot_text in ('41', '67', '62');
...
update livraisons_import set depot = 32 where depot_text = '00';
...
update livraisons_import set depot = 32 where depot_text in ('ZMM');
update livraisons_import set depot = 15 where depot_text in ('15');
update livraisons_import set depot = 6 where depot_text in ('06');
update livraisons_import set depot = 50 where depot_text in ('50');
...
update livraisons_import set depot = 51 where depot_text in ('51','52','53');
...
update livraisons_import set depot = 44 where depot_text in ('44','45');
update livraisons_import set depot = 30 where depot_text in ('30');
update livraisons_import set depot = 24 where depot_text in ('24');
...
update livraisons_import set depot = 74 where depot_text in ('74');
update livraisons_import set depot = 73 where depot_text in ('73');
...
update livraisons_import set depot = 20 where depot_text in ('20');
update livraisons_import set depot = 17 where depot_text in ('17');
update livraisons_import set depot = 40 where depot_text in ('40');
...
update livraisons_import set produit_id = 1 where produit in ('APS', 'APS15', 'MPSSO', 'MPSH', 'APDS','APSS12', 'APSS6', 'APDSS6', 'APDSS12', 'APDS15');
update livraisons_import set produit_id = 2 where produit in ('APF', 'APF15', 'MPFH', 'APDF', 'APSF12', 'APDF15');
...
where abonnement_id not in (28568, 29534, 28758, 29171,29561,28232,28263,28546,29560,28585,28588,29337,29591,28407,28408,28415,28405,28406,29438,28409,28544,29584,29592,28361,28690,28179,28694,29276,28798,29419,28623,28573,29511,28398,29501);
